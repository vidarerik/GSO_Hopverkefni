...
-- Hér byrjar Hluti A: Sigurður og Viðar unnu saman og ræddu um uppbyggingu töflu og gagnagrunns.
...
VALUES
("Led Zeppelin", '1968-01-08', "Led Zeppelin were an English rock band formed in London in 1968. 
...
though their unique style drew from a wide variety of influences, including folk music." ,1980, 2, "www.ledzeppelin.com", "England");

INSERT INTO flytjandi(nafn, faedingardagur, lysing, danardagur, tegund_flytjanda, vefsida, uppruni)
VALUES
("Mike Oldfield", '1953-04-15', "It was late one evening in 1973, 
...
INSERT INTO flytjandi(nafn, faedingardagur, lysing, danardagur, tegund_flytjanda, vefsida, uppruni)
VALUES
 ("Eminem", '1972-05-04', "Marshall Bruce Mathers III (born October 17, 1972),
 ...
 calling him the King of Hip Hop.", null, 1, "www.eminem.com", "United States");
 
 
INSERT INTO flytjandi(nafn, faedingardagur, lysing, danardagur, tegund_flytjanda, vefsida, uppruni)
VALUES
 ("Wes Montgomery", '1923-06-04' , "John Leslie Wes Montgomery (March 6, 1923 – June 15, 1968)
 ...
 2, "www.wesmontgomery.com", "United States");
 
 
INSERT INTO flytjandi(nafn, faedingardagur, lysing, danardagur, tegund_flytjanda, vefsida, uppruni)
VALUES
 ("Metallica", '1981-08-04' , "Metallica is an American heavy metal band based in San Rafael, California. 
 ...
 Guitarist Dave Mustaine and bassists Ron McGovney, Cliff Burton and Jason Newsted are former members of the band.", null, 2, "www.metallica.org", 
 "United States");
 
 
INSERT INTO flytjandi(nafn, faedingardagur, lysing, danardagur, tegund_flytjanda, vefsida, uppruni)
VALUES
 ("Andy Mckee", '1979-08-07' , "McKee played his first guitar, an Aria nylon string bought by his father, at age 13. 
 ...
 as he continued studying the instrument on his own.", null, 1, "www.andymckee.com", "United States");
 
 
INSERT INTO flytjandi(nafn, faedingardagur, lysing, danardagur, tegund_flytjanda, vefsida, uppruni)
VALUES
 ("DeadMau5", '1981-01-02' , "Joel Thomas Zimmerman (born January 5, 1981), better known by his stage name deadmau5 (pronounced dead mouse),
 ...
 "deadmau5.com", "United States" );
 
INSERT INTO flytjandi(nafn, faedingardagur, lysing, danardagur, tegund_flytjanda, vefsida, uppruni)
VALUES 
 ("Michael Jacksone", '1958-09-09' , "Michael Joseph Jackson[1][2] (August 29, 1958 – June 25, 2009) was an American singer, songwriter, record producer,
 ...
 "www.michaeljackson.org", "United States");


INSERT INTO flytjandi(nafn, faedingardagur, lysing, danardagur, tegund_flytjanda, vefsida, uppruni)
VALUES 
 ("Dire Straits", '1977-07-09', "Dire Straits were a British rock band that formed in 
 ...
 John Illsley (bass guitar and backing vocals), and Pick Withers (drums and percussion).", null, 2, "www.markknopfler.com", "England"); 
...
INSERT INTO diskur(nafn, utgafudagur, tegund_disks, tilnefningar, utgefandi, flytjandi)
VALUES
("Led Zeppelin IV", 1971, 3, null, 3, 1);
INSERT INTO diskur(nafn, utgafudagur, tegund_disks, tilnefningar, utgefandi, flytjandi)
VALUES
("The Eminem Show", 2002, 5, "Grammy Awards 2003", 5, 3);
INSERT INTO diskur(nafn, utgafudagur, tegund_disks, tilnefningar, utgefandi, flytjandi)
VALUES
("Master of Puppets", 1986, 1, "MTV Video Music Awards", 2, 5);
INSERT INTO diskur(nafn, utgafudagur, tegund_disks, tilnefningar, utgefandi, flytjandi)
VALUES
("Art Of Motion", 2005, 7, null, 6, 6);
INSERT INTO diskur(nafn, utgafudagur, tegund_disks, tilnefningar, utgefandi, flytjandi)
VALUES
("Far Wes", 1958, 4, null, 3, 4); -- elsti flytjandi
INSERT INTO diskur(nafn, utgafudagur, tegund_disks, tilnefningar, utgefandi, flytjandi)
VALUES
("Brother in Arms", 1985, 3, "MTV Music Awards", 4, 9);
INSERT INTO diskur(nafn, utgafudagur, tegund_disks, tilnefningar, utgefandi, flytjandi)
VALUES
("Thriller", 1982, 2, "World Music Awards", 4, 8);
INSERT INTO diskur(nafn, utgafudagur, tegund_disks, tilnefningar, utgefandi, flytjandi)
VALUES
("Tubular Bells", 1973, 6, "2010 Sydney Fringe Festival", 1, 2);
INSERT INTO diskur(nafn, utgafudagur, tegund_disks, tilnefningar, utgefandi, flytjandi)
VALUES
("Album Title Goes Here", 2012, 2, null , 8, 7);
...
-- Hér byrjar Hluti B: Gerið eftirfarandi fyrirspurnir.
...
SELECT nafn as Lag, sec_to_time(lengd) as Duration FROM lag WHERE sec_to_time(lengd) > sec_to_time(300) ORDER BY lengd DESC; -- d

SELECT nafn, utgafudagur FROM diskur WHERE utgafudagur > 2010; -- e 

SELECT utgefandi.nafn as Útgefandi , flytjandi.nafn as flytjandi, diskur.utgafudagur, diskur.nafn as Diskur
FROM utgefandi
JOIN diskur ON diskur.utgefandi = utgefandi.id
JOIN flytjandi ON flytjandi.id = diskur.flytjandi
ORDER BY IF(utgefandi.nafn RLIKE '^[a-z]', 1, 2), utgefandi.nafn LIMIT 2; -- f

SELECT flytjandi.nafn as Flytjandi, lag.nafn, sec_to_time(lag.lengd) as duration, utgefandi.nafn as 'Útgefandi', diskur.nafn as Diskur
FROM diskur
JOIN flytjandi ON diskur.flytjandi = flytjandi.id
JOIN utgefandi ON utgefandi.id = diskur.utgefandi
JOIN lag ON diskur.id = lag.diskur
ORDER BY lag.lengd DESC LIMIT 5; -- g

SELECT tegund.nafn as tegund, count(diskur.tegund_disks) as 'fjöldi_diska'
from diskur
JOIN tegund ON tegund.id = diskur.tegund_disks
GROUP BY tegund
ORDER BY count(diskur.tegund_disks) DESC LIMIT 2;  -- h - bara ein tegund hjá okkur með flesta 'rock' 

SELECT utgefandi.nafn as 'Útgefandi', count(diskur.utgefandi) as fjöldi_diska
FROM diskur
JOIN utgefandi ON utgefandi.id = diskur.utgefandi
GROUP BY utgefandi
ORDER BY count(diskur.utgefandi) ASC LIMIT 5; -- i - sýnir 5 sem eru fæstir

SELECT DISTINCT diskur.nafn as diskur, tegund.nafn as tegund, diskur.utgafudagur as útgáfudagur ,utgefandi.nafn as útgefandi
FROM diskur
JOIN utgefandi ON utgefandi.id = diskur.utgefandi
JOIN tegund ON diskur.tegund_disks = tegund.id WHERE diskur.utgafudagur BETWEEN 1998 AND 2017
GROUP BY utgefandi.nafn; -- j

SELECT count(nafn) as fjöldi_staf_sembyrja_bokstaf_a FROM lag WHERE nafn LIKE 'A%'; -- k

SELECT count(nafn) as fjöldi_staf_semhafa_bokstaf_s FROM lag WHERE nafn LIKE '%s%'; -- k2

SELECT nafn, TIMESTAMPDIFF(YEAR, faedingardagur, NOW()) AS age FROM flytjandi; -- l

SELECT round(avg(sec_to_time(lag.lengd))) as Meðallengd_allra_laga FROM lag; -- m

SELECT flytjandi.nafn as flytjandi, COUNT(lag.id) as Fjoldi_laga
FROM lag
JOIN flytjandi ON flytjandi.id = lag.flytjandi
GROUP BY flytjandi
HAVING COUNT(DISTINCT lag.id) > 4; -- n

SELECT flytjandi.nafn, flytjandi.faedingardagur as 'Fæðingardagur', lag.nafn as lag
from flytjandi 
JOIN lag ON lag.flytjandi = flytjandi.id
where flytjandi.faedingardagur = (
select min(flytjandi.faedingardagur) from flytjandi
); -- o Undirfyrirspurn
 
-- Bætið við 7 fyrirspurnum *
SELECT nafn, tilnefningar FROM diskur WHERE tilnefningar IS NULL;  -- 1 Select tilnefningar sem eru null

SELECT nafn, uppruni FROM flytjandi WHERE uppruni LIKE '%England%'; -- 2 Sýna flytjandi sem eru uppruni England

SELECT nafn, vefsida FROM flytjandi WHERE vefsida LIKE '%.org'; -- 3 Sýna vefsíður sem enda á .org

SELECT nafn, uppruni FROM flytjandi WHERE uppruni LIKE '%United States%'; -- 4 Sýna flytjandi sem eru upprunir U.S

SELECT nafn, vefsida FROM flytjandi WHERE vefsida LIKE '%.com'; -- 5 Sýna vefsíður sem enda á .com

SELECT nafn, count(tilnefningar) as Is_Tilnefningar FROM diskur GROUP BY nafn; -- 6 Sýna þá sem hafa true í tilnefningar

SELECT nafn, REPLACE (uppruni, 'England', 'Iceland') as Uppruni FROM flytjandi; -- 7 Replace England við Iceland

DROP TABLE flokkur,tegund,utgefandi,diskur,lag, flytjandi;

-- Hér með endar lokaverkefni í GSÖ, Takk fyrir okkur :)